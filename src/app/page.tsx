...
const BockSuiteLandingPage = () => {
  ...
  return (
    <div className="bg-black text-white h-screen-full">
      {/* Pre-Header Section */}
      <div className="bg-blue-800 py-2 text-center text-sm text-gray-200">
        <p>🚀 Limited Time Offer: Get 20% off on all Business Plans! Use code "BOCK20" at checkout.</p>
      </div>

      {/* Header */}
      <header className="bg-gray-900/80 backdrop-blur-md py-6 sticky top-0 z-50 shadow-md">
        <div className="container mx-auto px-4 flex justify-between items-center">
          ...
          <nav className="space-x-6">
            ...
            <a href="#pricingPlans" className="hover:text-blue-400 transition">Pricing</a>
          </nav>
        </div>
      </header>
      ...
      <div className="min-h-screen">
        <section className=" bg-gradient-to-r from-blue-900/70 to-gray-900/70 text-center py-20 relative overflow-hidden">
          ...
          <div className="container mx-auto relative z-10">
            ...
            <motion.p
              ...
              className="text-gray-300 text-2xl mb-8 max-w-3xl mx-auto"
            >
              Experience the ultimate suite of tools that streamline workflows, foster collaboration, and secure your data—all in one seamless platform.</motion.p><br/>
            <motion.div
            ...
            >
              <button className="bg-blue-600 px-8 py-4 text-lg rounded-full hover:bg-blue-700 transition transform hover:scale-105 shadow-lg hover:shadow-xl">
                Start Free Trial
              </button>
              <button className="bg-gray-800 px-8 py-4 text-lg rounded-full hover:bg-gray-700 transition transform hover:scale-105 shadow-lg hover:shadow-xl">
                Learn More
              </button>
            </motion.div>
          </div>
      ...
      <section className="py-16 text-center" id="features">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold mb-12">Our Suite</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {services.map((service) => (
              <motion.div
                ...
                className="bg-gray-900 p-8 rounded-lg shadow hover:shadow-lg transition group"
              >
      ...
      <motion.section
        ...
        transition={{ duration: 0.5 }}
        className="container mx-auto px-4 py-16 text-center min-win-h"
      >
        <h2 className="text-4xl font-bold mb-12">Why Choose Bock Suite?</h2>
        ...
        <div className="container mx-auto px-4 grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://x.com/BockBH" className="text-gray-400 hover:text-white transition"><Twitter size={24} /></a>
              <a href="https://www.instagram.com/bockbharath?igsh=b21ha21ycWx3eWxk" className="text-gray-400 hover:text-white transition"><Instagram size={24} /></a>
              <a href="https://www.facebook.com/people/Bock/61555404186214/" className="text-gray-400 hover:text-white transition"><Facebook size={24} /></a>
              <a href="https://www.linkedin.com/company/bockbharth/" className="text-gray-400 hover:text-white transition"><Linkedin size={24} /></a>
            </div>
          </div>
        </div>
